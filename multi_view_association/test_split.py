...
class ViewAssociation(object):
    def __init__(self, view1, view2):
        ...
        if self.target_view.name in ['1', '2']:
            source_points = self.target_view.vertical_lines[0] + self.target_view.vertical_lines[-1]      
        elif self.target_view.name in ['3', '4']:
            source_points = [self.target_view.vertical_lines[-1][1], self.target_view.vertical_lines[-1][0], self.target_view.vertical_lines[0][1], self.view2.vertical_lines[0][0]]
